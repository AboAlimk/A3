...
class A3Language{
    ...
    public static function getLanguagesCodes(){
        return array_keys(self::$languages);
    }
    public static function getLanguageTextLocal($key,$replace){
        return self::getLanguageText(A3::getLocal(),$key,$replace);
    }
    public static function getLanguageTextCustom($local,$key,$replace){
        return self::getLanguageText($local,$key,$replace);
    }
    public static function getLanguageText($local, $key ,$replace){
