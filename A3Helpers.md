...
```
### A3Assest
Return full link of assest file
Assests files are locateed in public_html

```php
A3Assest($uri = '',$version = false);
...
```
### A3Json
Return json array like {0:'',1:'',2:''}

```php
A3Json($item1,$item2 .... $item);
```
### A3JsonX
Return json array like {'x1':'','x2':'','x3':''}

```php
A3JsonX($item1,$item2 .... $item);
```
### A3GRS
